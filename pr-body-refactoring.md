...
- **60 pytest passed** (RED 17 + BCE 35 + GM 8); contracts unchanged (`unit:value`, table lines, `ParseError`)
...
- [x] `--cov=entity --cov=boundary` — entity **~95%** PASS; boundary package **~82%** (see report §5)
